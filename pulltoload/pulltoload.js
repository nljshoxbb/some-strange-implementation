(function () {
  ...
  function PullToLoad(selector, options) {
    ...
    if (
      ...
      document.querySelector(selector).tagName.toLowerCase() == "body"
    ) {
      isWindow = true;
      this.element = window;
  ...
  proto.setLoader = function () {
    var _loader =
      typeof this.options.loader === "string"
        ? document.querySelector(this.options.loader)
        : this.options.loader;
    if (_loader) {
  ...
  proto.onscroll = function () {
    if (isWindow) {
      this.onscroll = function () {
        ...
        console.log(scrollTop + viewPortHeight, docHeight);
      ...
      this.onscroll = function () {
        if (
          ...
          this.element.scrollHeight - this.options.threshold
        ) {
          this.append();
        }
      };
